...
impl BST {
 ...
 // Professor, este código esta rodando com 3 warnings quando eu dou o comando cargo test no arquivo lib.rs. Agora quando eu jogo esse código no arquivo main.rs roda sem nenhum warning